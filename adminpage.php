  ...
  <style type="text/css" src="style.css">
      *{
        ...
        table{
          ...
          .update_batch select, .update_batch label{
            margin-left: 2vw;
          ...
          */
          ...
          .footer-info{
            ...
            width: 100%;
            height: 10%;
            background: linear-gradient(to bottom, rgba(91, 198, 102, 0.686),rgb(49, 182, 37));
          }
          .footer-info h5{
              padding-top: 1%;
    ...
    <img src="poly.png" alt="altlogo">
        ...
        <ul class="menu-li">
            ...
            <li><a href="http://localhost/server/logout.php">LOGOUT</a></li>
        </ul>
    </nav>
    <section>
        <h1>Admin</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis deleniti labore ipsam assumenda nemo ipsum repellendus similique ad iure ipsa aut iusto quisquam quibusdam ex, dolore, veniam harum. Magnam, modi.</p>
                ...
                <div class="update_batch" id="toggle1">
                  <label>Department:
                    ...
                    <center><input type="submit" name="Update Batch"></center>
                    </form>
                </div>
                <form method="POST">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                              <div class="input-label">
                                ...
                                <label>SEM:
                                  <select  id="course2" name="sem" onchange="this.form.submit()">
                                    <option value="" selected disabled hidden>Choose here</option>
                                    <option value="first">I</option>
                                    <option value="second">II</option>
                                    <option value="third">III</option>
                                ...
                                <div class="dataTable-container">
                                    ...
                                    <tbody id="people">
                                        ...
                                        <tr id="myTr">
                                            ...
                                            <td><center><a href="http://localhost/server/msg1.php?course=<?php echo $row['course']; ?>&sem=<?php echo $row['sem'];?>&int=<?php echo'1IAT'; ?>"><input type="button" class="silver_button"name="Message" value="1IA"></a>
                                              <a href="http://localhost/server/msg1.php?course=<?php echo $row['course']; ?>&sem=<?php echo $row['sem'];?>&int=<?php echo'2IAT'; ?>"><input type="button" class="silver_button"name="Message" value="2IA"></a>
                                              <a href="http://localhost/server/msg1.php?course=<?php echo $row['course']; ?>&sem=<?php echo $row['sem'];?>&int=<?php echo'3IAT'; ?>"><input type="button" class="silver_button"name="Message" value="3IA"></a></center></td>
                                            <td><center><a href="cert_gen.php?course=<?php echo$row['course'];?>&reg=<?php echo $row['regno'];?>"><input type="button" class="grey_button"name="Card" value="Card"><input type="hidden" name="regi-num" value="<?php echo $row['regno']?>"></a></center></td>
                                            </tr>
                                            </tbody>
    ...
    <footer>
        <h5 align="center">©Projectworks 2022</h5>
      </footer>
  </div>
</body>
</html>